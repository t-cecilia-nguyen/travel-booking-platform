    ...
    public partial class databaseCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "Cool Car", new DateTime(2024, 5, 6, 18, 57, 40, 620, DateTimeKind.Local).AddTicks(9002), 0, new DateTime(2024, 3, 16, 18, 57, 40, 620, DateTimeKind.Local).AddTicks(8949), "123 str Toronto ON", 350.00m, "Big Company", null },
                    { 2, true, "SUV", new DateTime(2024, 3, 1, 18, 57, 40, 620, DateTimeKind.Local).AddTicks(9007), 0, new DateTime(2024, 2, 25, 18, 57, 40, 620, DateTimeKind.Local).AddTicks(9005), "456 Main St, Vancouver", 500.00m, "Rent-A-Car", null },
                    { 3, true, "Compact", new DateTime(2024, 2, 29, 18, 57, 40, 620, DateTimeKind.Local).AddTicks(9010), 0, new DateTime(2024, 2, 26, 18, 57, 40, 620, DateTimeKind.Local).AddTicks(9009), "789 Elm St, Calgary", 250.00m, "City Cars", null }
                });

            ...
            modelBuilder.Entity("GBC_Travel_Group_90.Models.CarRental", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Available = true,
                            CarModel = "Cool Car",
                            DropOffDate = new DateTime(2024, 5, 5, 16, 8, 7, 163, DateTimeKind.Local).AddTicks(9603),
                            MaxPassengers = 0,
                            PickUpDate = new DateTime(2024, 3, 15, 16, 8, 7, 163, DateTimeKind.Local).AddTicks(9552),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CarModel = "SUV",
                            DropOffDate = new DateTime(2024, 2, 29, 16, 8, 7, 163, DateTimeKind.Local).AddTicks(9609),
                            MaxPassengers = 0,
                            PickUpDate = new DateTime(2024, 2, 24, 16, 8, 7, 163, DateTimeKind.Local).AddTicks(9607),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CarModel = "Compact",
                            DropOffDate = new DateTime(2024, 2, 28, 16, 8, 7, 163, DateTimeKind.Local).AddTicks(9612),
                            MaxPassengers = 0,
                            PickUpDate = new DateTime(2024, 2, 25, 16, 8, 7, 163, DateTimeKind.Local).AddTicks(9611),

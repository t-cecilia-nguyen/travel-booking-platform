            ...
            modelBuilder.Entity("GBC_Travel_Group_90.Areas.TravelManagement.Models.CarRental", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Available = true,
                            CarModel = "Cool Car",
                            DropOffDate = new DateTime(2024, 6, 23, 19, 57, 8, 924, DateTimeKind.Local).AddTicks(10),
                            MaxPassengers = 4,
                            PickUpDate = new DateTime(2024, 5, 3, 19, 57, 8, 923, DateTimeKind.Local).AddTicks(9964),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CarModel = "SUV",
                            DropOffDate = new DateTime(2024, 4, 18, 19, 57, 8, 924, DateTimeKind.Local).AddTicks(16),
                            MaxPassengers = 5,
                            PickUpDate = new DateTime(2024, 4, 13, 19, 57, 8, 924, DateTimeKind.Local).AddTicks(15),
                        ...
                        new
                        {
                            ...
                            Available = true,
                            CarModel = "Compact",
                            DropOffDate = new DateTime(2024, 4, 17, 19, 57, 8, 924, DateTimeKind.Local).AddTicks(21),
                            MaxPassengers = 4,
                            PickUpDate = new DateTime(2024, 4, 14, 19, 57, 8, 924, DateTimeKind.Local).AddTicks(18),
